...
Example: generate all 7 note scales with no more than 4 consecutive tones
./pisces 7 4


The Problem
-----------
Within a 12 tone system, enumerate all 1 octave unique scales of N tones with 
no more than M consecutive tones.

A unique scale is a scale which cannot be formed by rotating any scale which
has already been enumerated.

Tones are consecutive when they are next to an active adjacent tone eg
A, A#, B, C are 4 consecutive tones.
...
111100000000 has 4 consecutive tones and so does 110000000011.

(X) 101101010110 and 
(Y) 101011010101 are considered as modes of the same scale 
